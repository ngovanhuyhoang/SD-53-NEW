...
namespace QuanApi.Migrations
{
    ...
    [Migration("20250613072035_njdsnkdn")]
    partial class njdsnkdn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuanApi.Data.ChiTietGioHang", b =>
                {
                    ...
                    b.Property<Guid?>("SanPhamChiTietIDSanPhamChiTiet")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanApi.Data.GioHang", b =>
                {
                    ...
                    b.Property<Guid?>("KhachHangIDKhachHang")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("QuanApi.Data.SanPham", b =>
                {
                    ...
                    b.Property<Guid?>("ChatLieuIDChatLieu")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DanhMucIDDanhMuc")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("KieuDangIDKieuDang")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime?>("LanCapNhatCuoi")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("LoaiOngIDLoaiOng")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("LungQuanIDLungQuan")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ThuongHieuIDThuongHieu")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ChatLieuIDChatLieu");

                    b.HasIndex("DanhMucIDDanhMuc");

                    b.HasIndex("KieuDangIDKieuDang");

                    b.HasIndex("LoaiOngIDLoaiOng");

                    b.HasIndex("LungQuanIDLungQuan");
            ...
            modelBuilder.Entity("QuanApi.Data.SanPhamChiTiet", b =>
                {
                    ...
                    b.Property<Guid?>("DotGiamGiaIDDotGiamGia")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("KichCoIDKichCo")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("MauSacIDMauSac")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DotGiamGiaIDDotGiamGia");

                    b.HasIndex("KichCoIDKichCo");
            ...
            modelBuilder.Entity("QuanApi.Data.TinNhan", b =>
                {
                    ...
                    b.Property<Guid?>("PhongTroChuyenIDPhongTroChuyen")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PhongTroChuyenIDPhongTroChuyen");
            ...
            modelBuilder.Entity("QuanApi.Data.SanPham", b =>
                {
                    b.HasOne("QuanApi.Data.ChatLieu", "ChatLieu")
                        .WithMany("SanPhams")
                        .HasForeignKey("ChatLieuIDChatLieu");

                    b.HasOne("QuanApi.Data.DanhMuc", "DanhMuc")
                        .WithMany("SanPhams")
                        .HasForeignKey("DanhMucIDDanhMuc");

                    b.HasOne("QuanApi.Data.KieuDang", "KieuDang")
                        .WithMany("SanPhams")
                        .HasForeignKey("KieuDangIDKieuDang");

                    b.HasOne("QuanApi.Data.LoaiOng", "LoaiOng")
                        .WithMany("SanPhams")
                        .HasForeignKey("LoaiOngIDLoaiOng");

                    b.HasOne("QuanApi.Data.LungQuan", "LungQuan")
                        .WithMany("SanPhams")
                        .HasForeignKey("LungQuanIDLungQuan");
            ...
            modelBuilder.Entity("QuanApi.Data.SanPhamChiTiet", b =>
                {
                    b.HasOne("QuanApi.Data.DotGiamGia", "DotGiamGia")
                        ...
                        .HasForeignKey("DotGiamGiaIDDotGiamGia");

                    b.HasOne("QuanApi.Data.KichCo", "KichCo")
                        .WithMany("SanPhamChiTiets")
                        .HasForeignKey("KichCoIDKichCo");
            ...
            modelBuilder.Entity("QuanApi.Data.TinNhan", b =>
                {
                    ...
                    b.HasOne("QuanApi.Data.PhongTroChuyen", "PhongTroChuyen")
                        .WithMany("TinNhans")
                        .HasForeignKey("PhongTroChuyenIDPhongTroChuyen");
